    ...
    const onSubmit = async (data: PatientFormValues) => {
        try {
            ...
            toast({
                ...
                description: `${patientData.nombre} ${patientData.apellido_paterno} ha sido guardado exitosamente.`,
            });
            ...
            await log({
                ...
                accion: "creó",
                entidad: "paciente",
                entidad_nombre: `${patientData.nombre} ${patientData.apellido_paterno}`,
            });
            ...
            toast({
                ...
                description: "No se pudo registrar al paciente. Intenta de nuevo.",
                variant: "destructive",
            });
        } finally {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-3xl h-[90vh] flex flex-col p-0 border-none bg-white rounded-3xl overflow-hidden">
                <DialogHeader className="px-6 py-5 border-b border-slate-100 bg-white flex-none relative">
                    <DialogTitle className="text-2xl font-semibold text-slate-900">Nuevo Paciente</DialogTitle>
                    <Button
                        type="button"
                        variant="ghost"
                        size="icon"
                ...
                <div className="flex-1 overflow-y-auto px-6 pt-1 pb-2">
                    <Form {...form}>
                        <form id="patient-form" autoComplete="off" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                                ...
                                                <FormControl>
                                                    <div className="flex group focus-within:ring-2 focus-within:ring-primary/20 rounded-xl transition-all">
                                                        ...
                                                        <input
                                                            ...
                                                            maxLength={9}
                                                            className="flex h-11 w-full bg-slate-50 border border-slate-200 rounded-r-xl px-3 py-2 text-sm focus:outline-none focus:bg-white transition-all"
                                                            onChange={(e) => {
                                                                const val = e.target.value.replace(/\D/g, "");
                ...
                <div className="px-6 py-5 border-t border-slate-100 flex justify-end gap-3 bg-white flex-none">
                    ...
                    <Button
                        type="submit"
                        form="patient-form"
                        className="h-11 min-w-[160px] rounded-xl bg-primary hover:bg-primary/90 text-white font-semibold transition-all shadow-md shadow-primary/20 active:scale-[0.98]"
                        disabled={isSubmitting}
                    >
                        {isSubmitting ? (
                            <>
